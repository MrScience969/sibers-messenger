    ...
    return (
        ...
        />
            ...
            <div className="new-message">
                <input className="new-message-input" type="text" aria-label="Ваше сообщение" placeholder="Напишите что-нибудь" required></input>
                <button className="new-message-button">Отправить</button>
            </div>
        </div>
    )
}
